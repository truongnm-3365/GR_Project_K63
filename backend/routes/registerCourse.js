...
const { getRegisterCourse, registerCourse, deleteRegisterCourse, completeVideo, completedVideo, courseExtend, completedCourse } = require('../controllers/registerCourseController');
...
router.route('/completedCourse/:id').post(isAuthenticatedUser,completedCourse)
