...
function ChatBot() {
  ...
  const [messages, setMessages] = useState([
    {
      message: "Xin chào tôi là Chat Bot thông minh, bạn có thể hỏi tôi bất kỳ cái gì",
      sentTime: "just now",
      sender: "ChatGPT"
    }
  ]);
        ...
        <MainContainer>
          <ChatContainer>       
            <MessageList 
              ...
              typingIndicator={isTyping ? <TypingIndicator content="Chat bot đang viết gì đó" /> : null}
            >
